...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href=" {{ asset('auth/backupAdminStyle/plugins/fontawesome-free/css/all.min.css') }} ">
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('auth/backupAdminStyle/css/adminlte.min.css') }} ">
    ...
    <style>
        .login-box {
            ...
            max-width: 470px;
            /* Sesuaikan dengan lebar maksimum login box */
            width: 100%;
            padding: 20px;
