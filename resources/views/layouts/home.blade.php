...
<body>
    ...
    <header id="header" class="d-flex flex-column justify-content-center">
        ...
        <nav id="navbar" class="navbar nav-menu">
            <ul>
                <li><a href="#hero" class="nav-link scrollto active"><i class="bx bx-home"></i> <span>Beranda</span></a>
                </li>
                <li><a href="#about" class="nav-link scrollto"><i class="bi bi-signpost-split"></i> <span>Pulau Tikus</span></a></li>
                <li><a href="#resume" class="nav-link scrollto"><i class="bi bi-map"></i> <span>Peta Persebaran</span></a>
                </li>
                <li><a href="#services" class="nav-link scrollto"><i class="bi bi-journals"></i> <span>Services</span></a>
                </li>
                <li><a href="#contact" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Tentang Kami</span></a>
                </li>
                <li><a href="{{ route('login.index') }}" class="nav-link scrollto"><i class="bi bi-box-arrow-in-right"></i> <span>Login</span></a>
                </li>
            </ul>
        </nav><!-- .nav-menu -->
    ...
    <section id="hero" class="d-flex flex-column justify-content-center">
        <div class="container" data-aos="zoom-in" data-aos-delay="100">
            ...
            <h1>Pulau Tikus</h1>
            <p>
                <span class="typed" data-typed-items="Provinsi Bengkulu, Pulau Eksotis, Pulau Terumbu Karang, Pulau Wisata">
