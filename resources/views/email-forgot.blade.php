                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <p class="f-fallback sub"
                                                            ...
                                                            Jika Anda mengalami masalah dengan tombol di atas, salin dan
                                                            tempel URL di bawah ke browser web Anda.</p>
                                                        <p class="f-fallback sub"
                                                            style="font-size: 13px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">
                                                            {!! $action_link !!}</p>
                                                    </td>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p class="f-fallback sub align-center"
                                            ...
                                            align="center">© 2023 <strong><i class="bi-back"></i> SIG Pulau Tikus</strong>. All rights reserved.</p>
