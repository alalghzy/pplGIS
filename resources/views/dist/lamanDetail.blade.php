                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" id="Coral" width="32px">
                                                <g data-name="Layer 3" fill="#fcfcfc" class="color000000 svgShape">
                                                    ...
                                                    <path
                                                        ...
                                                        fill="#fcfcfc" class="color000000 svgShape"></path>
                                                    <path d="M29.7,31H2.18a1,1,0,1,1,0-2H29.7a1,1,0,1,1,0,2Z" fill="#fcfcfc"
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start ">
                                        <div class="stats-icon yellow mb-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" id="Seaweed"
                                                width="32px">
                                                <g data-name="Layer 5" fill="#fcfcfc" class="color000000 svgShape">
                                                    <path
                                    ...
                                    <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start ">
                                        <div class="stats-icon purple mb-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" id="Coral"
                                                width="32px">
                                                <g data-name="Layer 4" fill="#fcfcfc" class="color000000 svgShape">
                                                    <path
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start ">
                                        <div class="stats-icon green mb-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="Fish"
                                                width="32px">
                                                <path
                                    ...
                                    <a data-bs-toggle="modal" data-bs-target="#lihatGambar">
                                        ...
                                        <center>
                                            <img src="{{ asset('storage/posts/' . $post->image) }}"
                                                ...
                                                style="max-height: 500px; max-width: 90%" alt="{{ $post->image }}">
                                        </center>
                                    </a>
                                    @include('dist.includes.Detail.modalLihatGambar')
                                </div>
                            @else
                                <div class="alert alert-light-danger color-danger alert-dismissible show fade m-3 p-3">
                                    <i class="fa-solid fa-triangle-exclamation"></i> <span style="font-size:12px">Gambar
