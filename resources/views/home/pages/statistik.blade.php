        ...
        <div class="row justify-content-center align-items-center" style="margin-top: -5%;">
            <div class="col-lg-3 col-md-6">
                <div class="count-box"
                    ...
                    <div class="tengah"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" id="Coral" width="30"
                            height="30">
                            <path
            ...
            <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
                <div class="count-box"
                    ...
                    <div class="tengah"
                        style="width: 50px; height: 50px; display: flex; align-items: center; justify-content: center; border-radius: 50%; background-color: #0563bb;">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 66 66" id="Turtle" width="30"
                            height="30">
                            <path
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="4000" data-purecounter-duration="2"
